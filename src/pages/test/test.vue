<template>
    <div class="test">
        ...
        <pickerWrap :mode="'multiSelector'" :range="gangedArr" :value="gangedArrIndex" :ganged="true" :change="gChangeFn" :cancel="gCancelFn" :columnchange="gColumnchangeFn" />
        <pickerWrap :mode="'time'" :value="time" :change="tChangeFn" />
        <pickerWrap :mode="'date'" :value="date" :change="dChangeFn" />
        <pickerWrap :mode="'region'" :value="region" :change="rChangeFn" />
